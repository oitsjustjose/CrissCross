 ...
 * 
 * @author TeamCoFH
 * All credit goes to TeamCoFH, this was required for proper woodchipper recipes :)
 *
 */
...
public class ItemHelper
{
	...
	public static ItemStack findMatchingRecipe(InventoryCrafting inv, World world)
	{
		...
		if (dmgItems[0] == null || dmgItems[0].getItem() == null)
		{
			...
			if (dmgItems[1] != null && dmgItems[0].getItem() == dmgItems[1].getItem() && dmgItems[0].stackSize == 1
