...
public class GUIAtmosManipulator extends GuiScreen
{
    ...
    private GUIAtmosManipulator.NextPageButton buttonNextPage;
    private GUIAtmosManipulator.NextPageButton buttonPreviousPage;
    ...
    public GUIAtmosManipulator(EntityPlayer player, ItemStack book, boolean isUnsigned)
    {
    ...
    public void initGui()
    {
        ...
        int j = 2;
        this.buttonList.add(this.buttonNextPage = new GUIAtmosManipulator.NextPageButton(1, i + 120, j + 154, true));
        this.buttonList.add(this.buttonPreviousPage = new GUIAtmosManipulator.NextPageButton(2, i + 38, j + 154, false));
        this.updateButtons();
    }
    ...
    static class NextPageButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft mc, int mouseX, int mouseY)
            {
                if (this.visible)
                {
                    ...
                    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                    mc.getTextureManager().bindTexture(GUIAtmosManipulator.bookGuiTextures);
                    int i = 0;
                    int j = 192;
