...
public class BlockAutosmith extends BlockMachineBase
{
	private static String unlocName = "autosmith";
	public BlockAutosmith()
	{
		super(unlocName);
		
		GameRegistry.registerTileEntity(TileEntityAutosmith.class, unlocName);
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int meta)
	{
		...
		TileEntityAutosmith tile = (TileEntityAutosmith) world.getTileEntity(x, y, z);
	...
	{
		return new TileEntityAutosmith();
	}
			...
			float hitY, float hitZ)
	{
		...
		{
			TileEntityAutosmith tileentityautosmith = (TileEntityAutosmith) world.getTileEntity(x, y, z);
			if(tileentityautosmith != null)
				player.openGui(CrissCross.instance, GUIHandler.Autosmith, world, x, y, z);
			return true;
		}
	}
}
