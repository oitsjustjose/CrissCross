...
public class TileEntityCobblegen extends TileEntity implements ISidedInventory
{
	...
	public void updateEntity()
	{
		...
		if(!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockCobblegen.updateBlockState(this.fuelTime > 0, this.worldObj, this.xCoord, this.yCoord,
						this.zCoord);
			}
		}
