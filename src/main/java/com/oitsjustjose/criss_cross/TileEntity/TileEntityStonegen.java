...
public class TileEntityStonegen extends TileEntity implements ISidedInventory
{
	...
	public void updateEntity()
	{
		...
		if(!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockStonegen.updateBlockState(this.fuelTime > 0, this.worldObj, this.xCoord, this.yCoord,
						this.zCoord);
			}
		}
