...
{
	private static int proTicks = Config.cropomatorProcessTime;
	private static int qty = Config.cropomatorOutput;
	...
	{
		return new ContainerCropomator(playerInventory.player, this);
	}
